    ...
    const handleCheckBox = () => {
        ...
        if (checkbox.checked) {
            ...
            for (let i = 0; i < legendTextElements.length; i++) {
                const legendTextElement = legendTextElements[i];
                legendTextElement.style.color = 'black'; // Set the text color to white
                // Add any other styles you want to change here
            }
            ...
            for (let i = 0; i < legendTextElements.length; i++) {
                const legendTextElement = legendTextElements[i];
                legendTextElement.style.color = 'white'; // Set the text color to white
                // Add any other styles you want to change here
            }
        }
    }
